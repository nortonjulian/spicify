...
router.get('/spoonacular', async(req, res) => {
    try {
        ...
        // const requestUrl = `https://api.spoonacular.com/recipes/findByIngredients?apiKey=${apiKey}&seasonings=${formattedQuery}&number=100`;
